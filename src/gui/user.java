...
public class user extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tbuser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID User", "Username", "Password", "Nama User"
            }
        ));
...
private void simpandata() {
        ...
        if (txtiduser.getText().isEmpty() || txtusername.getText().isEmpty() || txtpassword.getText().isEmpty() || txtnamauser.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane,"Silahkan isi data terlebih dahulu !","Informasi",JOptionPane.INFORMATION_MESSAGE);
        } else {
            u.simpandata(iduser, username, password, namauser);
...
private void updatedata() {
        ...
        if (conf == 0) {
            u.updatedata(iduser, username, password, namauser);
            tampildata();
